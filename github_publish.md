Да, это отличная практика. Вы можете полностью автоматизировать процесс публикации обновлений в Expo Go с помощью GitHub Actions.

Как только вы (или ваш коллега) создадите PR или сделаете пуш в ветку main, GitHub запустит виртуальную машину, которая сама выполнит команду eas update.
